...
@PropertyComputer
public class NoOfClientsDoingDescendantsCasts implements IPropertyComputer<Integer, MClass> {

	@Override
	public Integer compute(MClass arg0) {
		List<MMethod> methodsWithCasts = arg0.methodsWithDescendantsCasts().getElements();
